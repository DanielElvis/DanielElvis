...
<h1>The Tools I Worked With</h1>
I had the experience of working with the following tools and completed my projects with their help:
<br>
<br>

![My Skills](https://skillicons.dev/icons?i=python,html,css,bootstrap,django,mysql,sqlite,stackoverflow,vscode,windows,pycharm,c,git,github,wordpress)
